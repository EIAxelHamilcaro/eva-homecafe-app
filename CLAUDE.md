...
### Mobile Native Guidelines

No native Figma design → Improvise while respecting:
- Consistent design system with web mockups
- Native iOS/Android UX (gestures, haptics, transitions)
- NativeWind for styling (Tailwind on React Native)
- Mobile-adapted components (bottom sheets, swipe actions)
